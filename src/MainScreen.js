...
class MainScreen extends Component {
  ...
  renderPrivacyPolicy = () => {
    return (
      <div className={"PrivacyPolicy"}>
        ...
        <p>Last updated: February 28, 2020</p>
        ...
        <ul>
          ...
          <li>
            <p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Flix Attire.</p>
          </li>
          <li><strong>Affiliate</strong> means an entity that controls, is controlled by or is under common control with a party, where "control" means ownership of 50% or more of the shares, equity interest or other securities entitled to vote for election of directors or other managing authority.</li>
          <li><strong>Account</strong> means a unique account created for You to access our Service or parts of our Service.</li>
          <li><strong>Website</strong> refers to Flix Attire, accessible from http://www.flixattire.com</li>        <li><strong>Service</strong> refers to the Website.</li>
        ...
        <ul>
          <li>By email: joshkardos@gmail.com</li>
        </ul>
      </div>
    )
  }
  ...
  renderSupportLayout = () => {
    return (
      <div className="Support">
        <p>Email @ joshkardos@gmail.com</p>
      </div>
    )
  }
  ...
  render() {
    ...
    return (
      <div className="App">
        <div className="Right">
          <MenuBarItem label="Privacy Policy" onClick={() => { this.setState({ layout: "Privacy Policy"})}} />
          <MenuBarItem label="Support" onClick={() => { this.setState({ layout: "Support" })}} />
          <MenuBarItem label="Home" onClick={() => { this.setState({ layout: "Home" })}} />

        </div>

        {layout === "Home" && this.renderHomeLayout()}
        {layout === "Privacy Policy" && this.renderPrivacyPolicy()}
        {layout === "Support" && this.renderSupportLayout()}
